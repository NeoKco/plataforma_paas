...
require_crm_read = require_tenant_permission("tenant.crm.read")
require_crm_manage = require_tenant_permission("tenant.crm.manage")


def build_crm_requested_by(context: dict) -> TenantUserContextResponse:

...
def _build_history_item(entry: dict) -> MaintenanceHistoryWorkOrderItemResponse:
    ...
    return MaintenanceHistoryWorkOrderItemResponse(
        ...
        finance_summary=MaintenanceHistoryFinanceSummaryResponse(
            ...
            income_is_reconciled=finance_summary["income_is_reconciled"],
            expense_is_reconciled=finance_summary["expense_is_reconciled"],
            income_is_voided=finance_summary["income_is_voided"],
            expense_is_voided=finance_summary["expense_is_voided"],
            income_has_account=finance_summary["income_has_account"],
            expense_has_account=finance_summary["expense_has_account"],
            income_has_category=finance_summary["income_has_category"],
            expense_has_category=finance_summary["expense_has_category"],
        ),

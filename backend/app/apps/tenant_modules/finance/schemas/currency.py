...
class FinanceCurrencyMutationResponse(FinanceResponseBase):
    data: FinanceCurrencyItemResponse


class FinanceCurrenciesResponse(FinanceResponseBase):
    total: int
    data: list[FinanceCurrencyItemResponse]

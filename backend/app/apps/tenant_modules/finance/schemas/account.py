...
class FinanceAccountMutationResponse(FinanceResponseBase):
    data: FinanceAccountItemResponse


class FinanceAccountsResponse(FinanceResponseBase):
    total: int
    data: list[FinanceAccountItemResponse]

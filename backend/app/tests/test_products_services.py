...
class ProductsServicesTestCase(unittest.TestCase):
    ...
    def test_build_product_image_data_url_infers_content_type_from_bytes(self) -> None:
        tenant_db = Mock()
        product = CRMProduct(id=12, name="Cable RV-K")
        image = ProductCatalogImage(
            id=1,
            product_id=12,
            file_name="legacy-photo",
            storage_key="product_12/legacy-photo.bin",
        ...
        self.assertTrue(str(payload["data_url"]).startswith("data:image/jpeg;base64,"))

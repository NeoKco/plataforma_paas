...
class FinanceLoanCoreTestCase(unittest.TestCase):
    ...
    def test_apply_installment_payment_updates_installment_and_loan_balance(self) -> None:
        ...
        self.assertEqual(accounting_transactions[0]["loan_type"], "borrowed")
        self.assertEqual(accounting_transactions[0]["counterparty_name"], "Banco Pago")
        self.assertEqual(accounting_transactions[0]["installment_number"], 1)
        self.assertEqual(accounting_transactions[0]["account_name"], "Caja operativa")
        self.assertEqual(accounting_transactions[0]["signed_amount"], -200.0)
        self.assertEqual(accounting_transactions[0]["signed_amount_in_base_currency"], -200.0)

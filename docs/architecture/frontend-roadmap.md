...
- `finance` ya expone una primera pantalla moderna de transacciones sobre `finance_transactions`, con balances por cuenta, panel de detalle operacional, filtros reales, modo edicion sobre la misma vista y una mesa de trabajo basica con seleccion multiple para favoritas/conciliacion
...
- completar la vista moderna de transacciones con conciliacion asistida mas rica antes de abrir mas dominios grandes dentro de finance

...
- `finance` ya expone una primera pantalla moderna de transacciones sobre `finance_transactions`, con balances por cuenta, panel de detalle operacional, filtros reales y modo edicion sobre la misma vista
...
- completar la vista moderna de transacciones con mesas de trabajo mas ricas para conciliacion/favoritos antes de abrir mas dominios grandes dentro de finance

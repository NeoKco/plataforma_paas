...
- `finance` ya permite aplicar pagos manuales simples sobre cuotas del cronograma
...
- endurecer pagos de `Préstamos` con amortizacion, reversa y operaciones masivas antes de darlo por base cerrada

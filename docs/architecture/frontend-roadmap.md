...
- abrir exportaciones adicionales enriquecidas y comparativas más profundas entre rangos arbitrarios, acumulados específicos o cortes por dimensión analítica en `Reportes`

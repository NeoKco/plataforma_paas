...
- el trabajo transversal de `design system` ya quedó iniciado en frontend con iconografia común, `spotlight` genérico, badges y layouts reutilizables; lo que sigue es expandir esa base desde `finance` al resto del producto

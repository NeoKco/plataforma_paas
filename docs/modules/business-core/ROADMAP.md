...
- merge profundo de `organizations` y consolidacion documental de `contacts`: ya resuelve asimilacion guiada de múltiples clientes en conflicto, integra campos visibles base y permite selección manual por campo; falta criterio documental profundo y fusión manual asistida de identidad completa

...
- en la ficha del cliente, `Mantenciones realizadas` no deberia leer la bandeja operativa abierta; debe mostrar solo trabajo cerrado de ese cliente, tomado desde historial tecnico, incluyendo el estado final y la descripcion util de lo que ocurrio con el equipo.

...
- en la ficha del cliente, `Mantenciones recientes` no deberia leer la bandeja operativa abierta; debe mostrar solo mantenciones `realizadas` de ese cliente, tomadas desde el historial tecnico cerrado.

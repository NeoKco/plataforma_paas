...
- el corte contractual `maintenance` + bootstrap financiero por vertical ya quedó validado en repo y publicado en `staging`; falta decidir si se promueve a `production`

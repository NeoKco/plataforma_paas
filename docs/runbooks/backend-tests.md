...
```bash
cd /home/felipe/platform_paas/backend
/home/felipe/platform_paas/platform_paas_venv/bin/python -m unittest app.tests.test_tenant_finance_flow app.tests.test_finance_catalog_repositories app.tests.test_finance_catalog_services app.tests.test_finance_catalog_routes app.tests.test_finance_transaction_core app.tests.test_finance_budget_core app.tests.test_finance_loan_core app.tests.test_migration_flow
```
...
Suite puntual de préstamos:

```bash
cd /home/felipe/platform_paas/backend
/home/felipe/platform_paas/platform_paas_venv/bin/python -m unittest app.tests.test_finance_loan_core
```

...
- `Cuentas`, `Categorías` y `Configuración` ya empezaron además la migración visible de catálogos usando badges, toolbars, wrappers de tabla y formularios compartidos en vez de estructura manual repetida

...
- `Préstamos` ya expone un cronograma inicial por cuotas y ya permite aplicar pagos manuales simples, aunque todavía no cubre amortización avanzada ni enlace contable real

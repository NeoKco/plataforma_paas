...
TENANT_DATA_EXPORT_ARTIFACTS_DIR_VALUE="${TENANT_DATA_EXPORT_ARTIFACTS_DIR:-$PROJECT_ROOT/storage/tenant_data_exports}"
FINANCE_ATTACHMENTS_DIR_VALUE="${FINANCE_ATTACHMENTS_DIR:-$PROJECT_ROOT/storage/finance_attachments}"
MAINTENANCE_EVIDENCE_DIR_VALUE="${MAINTENANCE_EVIDENCE_DIR:-$PROJECT_ROOT/storage/maintenance_evidence}"
mkdir -p "$TENANT_DATA_EXPORT_ARTIFACTS_DIR_VALUE"
mkdir -p "$FINANCE_ATTACHMENTS_DIR_VALUE"
mkdir -p "$MAINTENANCE_EVIDENCE_DIR_VALUE"
chown -R "$SERVICE_RUNTIME_USER:$SERVICE_RUNTIME_GROUP" "$TENANT_DATA_EXPORT_ARTIFACTS_DIR_VALUE"
chown -R "$SERVICE_RUNTIME_USER:$SERVICE_RUNTIME_GROUP" "$FINANCE_ATTACHMENTS_DIR_VALUE"
chown -R "$SERVICE_RUNTIME_USER:$SERVICE_RUNTIME_GROUP" "$MAINTENANCE_EVIDENCE_DIR_VALUE"
